# spec/policies/set_instructor_policy_spec.rb

require_relative '../spec_helper'

require_relative '../../app/policies/set_instructor_policy'

RSpec.describe SetInstructorPolicy do
  describe ".new" do
    let(:user) {
      double('User')
    }
    ...
    it "accepts a user and resource as params" do
      expect{ SetInstructorPolicy.new(user, resource) }.not_to raise_exception
    end

    it "returns the user passed to the constructor" do
      policy = SetInstructorPolicy.new(user, resource)
  ...
  describe "#allowed?" do
    ...
    let(:policy) {
      SetInstructorPolicy.new(user, resource)
    }
  ...
  describe "#authorize!" do
    ...
    let(:resource) { double("SetInstructor") }
    let(:policy) { SetInstructorPolicy.new(user, resource) }
